...
//
 std::string GlKinematicBody::evalMeshFilePath(std::string file_path_expression, bool return_convex_hull_path)
  {
    std::string result = "";
    // was:  std::string package_path = std::string(getModelsPath()) + "/mit_gazebo_models/"; // getModelsPath gives /drc/software/build/models
    std::string package_path = std::string(getModelsPath()) + "/"; // getModelsPath gives /drc/software/build/models
